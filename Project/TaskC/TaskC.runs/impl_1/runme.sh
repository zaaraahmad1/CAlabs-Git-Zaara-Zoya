...
HD_PWD='C:/Users/DELL/Desktop/CA-Labs-main/CA-Labs-main/Project/Part C/Project_Verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log taskC_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source taskC_top.tcl -notrace
