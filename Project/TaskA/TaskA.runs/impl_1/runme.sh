...
HD_PWD='C:/Users/DELL/Desktop/CA-Labs-main/CA-Labs-main/Project/Part A/Project_Verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log taskA_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source taskA_top.tcl -notrace
