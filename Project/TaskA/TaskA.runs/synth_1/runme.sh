...
HD_PWD='C:/Users/DELL/Desktop/CA-Labs-main/CA-Labs-main/Project/Part A/Project_Verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log taskA_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source taskA_top.tcl
