...
HD_PWD='C:/Users/za10196/Downloads/project_zaara/project_zaara/project_latest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab9_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab9_top.tcl
