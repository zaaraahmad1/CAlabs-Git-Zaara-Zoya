...
HD_PWD='C:/Users/za10196/Downloads/project_zaara/project_zaara/project_latest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab9_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab9_top.tcl -notrace
